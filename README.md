...
| **NVIDIA Manager Agent** | Manager agent that suggests NVIDIA workflows, runs iterative loop pipelines, and trains specialist agent playbooks. | [`nvidia-manager-agent`](skills/nvidia-manager-agent) |
...
| **NVIDIA Manager Agent** | [Issues](https://github.com/NVIDIA/skills/issues) | [Discussions](https://github.com/NVIDIA/skills/discussions) | [Contributing](https://github.com/NVIDIA/skills/blob/main/CONTRIBUTING.md) | [Security](https://github.com/NVIDIA/skills/blob/main/SECURITY.md) |
